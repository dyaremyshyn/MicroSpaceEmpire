...
//      List<Carta> porConquistar = this.observableGame.getPorConquistar();
...
//      };
    ...
    class DestaqueListener extends MouseAdapter 
    {
        ...
        public void mousePressed( MouseEvent e)
        {
             ...
             if(!(x > porConquistar.size()*DIM_X_CARTA))
             {
             i = qualFigura(x, y);
             System.out.println("carreguei para conquistar! e foi o" + i);
             if(i != -1)
             {    
