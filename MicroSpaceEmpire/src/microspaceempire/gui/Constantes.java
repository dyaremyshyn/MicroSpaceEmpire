...
public interface Constantes {
    ...
    String METAL = "Metal";
    String PATH_IMG_METAL = "images/Metal.png";
    ...
    String PATH_IMG_SYSTEM = "images/System.png";
    
    String TECHNOLOGY = "Technology";
    String PATH_IMG_TECHNOLOGY = "images/Technology.png";
    
    String WEALTH = "Wealth";
    String PATH_IMG_WEALTH = "images/Wealth.png";
    
    String FUNDOINICIO = "fundoInicio";
    String PATH_IMG_FUNDOINICIO = "images/fundoInicio.gif";
